(function () {
    ...
    function fragmentLoad(elements, options) {
        ...
        elements.querySelector('.pageTitle').textContent = "Order from " + item.date;

        WinJS.UI.processAll(elements)
            .then(function () {
                elements.querySelector('#status').src = "/images/content/" + item.status + ".png";
                elements.querySelector('.customerName').innerHTML = item.customerName;
                elements.querySelector('.customerAddress').innerHTML = item.customerAddress;
                elements.querySelector('.customerPhone').innerHTML = item.customerPhone;
                elements.querySelector('.content').innerHTML = item.orderItems.join("<br />");
            });
    }
